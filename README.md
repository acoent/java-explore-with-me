...
- Ссылка на пул-реквест: https://github.com/acoent/java-explore-with-me/pull/4
...
Коллекция для быстрой проверки сценариев: `postman/feature.json`. Перед запуском настройте переменные `baseUrl`, `userId` и `eventId`.
